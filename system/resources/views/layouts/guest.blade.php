...
<head>
    ...
    @endif
    @hasSection('theme_color')
        <meta name="theme-color" content="@yield('theme_color')">
    @endif
...
<body class="@yield('body_class', 'min-h-screen flex items-center justify-center bg-neutral-50 dark:bg-neutral-0 p-4 antialiased')">
    @php
