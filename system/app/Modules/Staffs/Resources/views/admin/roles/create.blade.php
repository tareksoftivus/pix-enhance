<x-layouts.admin :title="__('Create Role')">
    <div class="space-y-6">
        <div class="flex items-center justify-between">
            <h1 class="heading-4 text-neutral-950">{{ __('Create Role') }}</h1>
        ...
        <div class="section-card">
            <form method="POST" action="{{ route('admin.roles.store') }}" class="space-y-6 max-w-2xl">
                @csrf
                <x-forms.input :label="__('Role Name')" name="name" required :placeholder="__('Enter role name')" />
